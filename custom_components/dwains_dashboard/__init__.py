...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    domain_data.setdefault("latest_version", "")
...
async def _rollback_entry_setup(hass, config_entry) -> None:
    ...
    try:
        ...
        _LOGGER.exception("Failed to roll back the Dwains Dashboard sensor platform")
...
async def async_unload_entry(hass, config_entry):
    ...
    The per-entry frontend URLs are removable, while the static path and
